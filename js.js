...
function initReceitas(){ //Iniciar com algumas receitas (Por enquanto apenas para desenvolvimento)
	...
	document.getElementById('Home').insertBefore(document.getElementById('receitasFeed1'), document.getElementById('receitasFeed2')); //receitas1 sempre fica no final, ao fazer o código da estrutura, o 'receitasFeed1' fica de fora  e torto.. Por isso todas as receitas precisam estar em ordem crescente...
